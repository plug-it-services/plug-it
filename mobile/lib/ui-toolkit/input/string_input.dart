  ...
  Widget build(BuildContext context) {
    return Column(mainAxisAlignment: MainAxisAlignment.center, children: [
      Row(
        ...
        children: [
          Text(
              (!widget.templateField.required)
                  ? "${widget.templateField.displayName}: "
                  : "${widget.templateField.displayName} (required): ",
              style: (!widget.templateField.required)
                  ? PlugItStyle.subtitleStyle
                  : PlugItStyle.subtitleStyleWarning),
          (!widget.isTrigger)
              ? VariableMenu(
                  onVariableSelected:
                      (Event event, Variable variable, int idx) {
      ...
      Padding(
        ...
        child: Text(widget.templateField.description,
